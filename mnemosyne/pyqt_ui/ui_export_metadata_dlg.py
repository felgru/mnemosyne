...
class Ui_ExportMetadataDlg(object):
    def setupUi(self, ExportMetadataDlg):
        ...
        self.label = QtWidgets.QLabel(ExportMetadataDlg)
        self.label.setObjectName("label")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label)
        self.card_set_name = QtWidgets.QLineEdit(ExportMetadataDlg)
        self.card_set_name.setObjectName("card_set_name")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.card_set_name)
        self.label_2 = QtWidgets.QLabel(ExportMetadataDlg)
        self.label_2.setObjectName("label_2")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_2)
        self.author_name = QtWidgets.QLineEdit(ExportMetadataDlg)
        self.author_name.setObjectName("author_name")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.author_name)
        self.label_3 = QtWidgets.QLabel(ExportMetadataDlg)
        self.label_3.setObjectName("label_3")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_3)
        self.label_4 = QtWidgets.QLabel(ExportMetadataDlg)
        self.label_4.setObjectName("label_4")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.label_4)
        self.date = QtWidgets.QDateEdit(ExportMetadataDlg)
        self.date.setObjectName("date")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.date)
        self.label_5 = QtWidgets.QLabel(ExportMetadataDlg)
        self.label_5.setObjectName("label_5")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.label_5)
        self.revision = QtWidgets.QSpinBox(ExportMetadataDlg)
        self.revision.setMinimum(1)
        self.revision.setMaximum(9999)
        self.revision.setObjectName("revision")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.revision)
        self.author_email = QtWidgets.QLineEdit(ExportMetadataDlg)
        self.author_email.setObjectName("author_email")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.author_email)
        self.tags = QtWidgets.QLineEdit(ExportMetadataDlg)
        self.tags.setObjectName("tags")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.tags)
        self.label_7 = QtWidgets.QLabel(ExportMetadataDlg)
        self.label_7.setObjectName("label_7")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_7)
        self.verticalLayout.addLayout(self.formLayout)
        self.label_6 = QtWidgets.QLabel(ExportMetadataDlg)
        self.label_6.setObjectName("label_6")
        self.verticalLayout.addWidget(self.label_6)
        self.notes = QtWidgets.QPlainTextEdit(ExportMetadataDlg)
        self.notes.setObjectName("notes")
        self.verticalLayout.addWidget(self.notes)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.ok_button = QtWidgets.QPushButton(ExportMetadataDlg)
        ...
        self.ok_button.clicked.connect(ExportMetadataDlg.accept)
